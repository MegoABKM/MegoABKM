...
import 'package:schoolmanagement/controller/auth/loginschool_controller.dart';
import 'package:schoolmanagement/core/constant/routes.dart';
import 'package:schoolmanagement/core/functions/validinput.dart';

class SchoolManagementLogin extends StatelessWidget {
  final SchoolLoginController loginController =
                    ...
                    child: Column(
                      children: [
                        ...
                        Align(
                          ...
                          child: TextButton(
                            onPressed: () {
                              Get.toNamed(AppRoute.schoolforgetPassword);
                            },
                            child: Text(
                              'نسيت كلمة المرور؟',
                        ...
                        const SizedBox(height: 20),
                        GetBuilder<SchoolLoginController>(
                          builder: (controller) {
                        ...
                        TextButton(
                          onPressed: () {
                            Get.offNamed(AppRoute.signupschool);
                          },
                          child: Text(
