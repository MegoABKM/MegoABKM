...
class ScaleConfig {
  ...
  double scale(double size) {
    ...
    // These are the potential boundaries for our clamp
    final bound1 = size * 0.8;
    final bound2 = size * 2.0;

    // By using min and max, we ensure the lower bound is always
    // less than or equal to the upper bound, regardless of whether
    // the input 'size' is positive or negative.
    return scaledSize.clamp(min(bound1, bound2), max(bound1, bound2));
  }
