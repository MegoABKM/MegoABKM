...
function uploadFile($fileRequest)
{
    ...
    // Define upload path
    $uploadPath = __DIR__ . "/upload/files/company/profile/";
    ...
    if (move_uploaded_file($fileTmp, $uploadPath . $filename)) {
        $url = 'https://localhost:8080/upload/files/company/profile/' . $filename;
...
uploadFile("file"); // Call the upload function to process the file
?>
