...
import 'customtaskcard/task_info_row.dart';
import 'customtaskcard/task_title_row.dart';
import 'customtaskcard/task_translator.dart';
          ...
          child: Column(
            ...
            children: [
              ...
              TaskInfoRow.build(
                ...
                label: task.estimatetime != "Not Set"
                    ? DateFormat("dd MMM, hh:mm a")
                        .format(DateTime.parse(task.estimatetime!))
                    : "",
                visible: task.estimatetime != "Not Set",
                scale: scale,
              ),
              SizedBox(height: scale.scale(4)),
              TaskInfoRow.build(
