...
import 'package:tasknotate/controller/company/manager/crudcompany/createcompany_controller.dart';
...
class CreateCompany extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final CreatecompanyController controller =
